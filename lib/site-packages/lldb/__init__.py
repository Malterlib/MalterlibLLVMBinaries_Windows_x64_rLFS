...
LLDB_INVALID_FRAME_PROVIDER_ID = _lldb.LLDB_INVALID_FRAME_PROVIDER_ID
...
ePluginDomainKindGlobal = _lldb.ePluginDomainKindGlobal

ePluginDomainKindDebugger = _lldb.ePluginDomainKindDebugger

ePluginDomainKindTarget = _lldb.ePluginDomainKindTarget
...
eArgTypeFrameProviderIDRange = _lldb.eArgTypeFrameProviderIDRange
...
r"""
    ...
    """
eCommandAllowsDummyTarget = _lldb.eCommandAllowsDummyTarget
r"""
...
eSymbolSharedCacheUseHostLLDBMemory = _lldb.eSymbolSharedCacheUseHostLLDBMemory

eSymbolSharedCacheUseHostSharedCache = _lldb.eSymbolSharedCacheUseHostSharedCache

eSymbolSharedCacheUseHostAndInferiorSharedCache = _lldb.eSymbolSharedCacheUseHostAndInferiorSharedCache

eSymbolSharedCacheUseInferiorSharedCacheOnly = _lldb.eSymbolSharedCacheUseInferiorSharedCacheOnly
...
eDILModeSimple = _lldb.eDILModeSimple
r"""Allowed: identifiers, operators: '.'."""
...
class SBBlock(object):
    ...
    def __eq__(self, rhs):
        r"""__eq__(SBBlock self, SBBlock rhs) -> bool"""
        return _lldb.SBBlock___eq__(self, rhs)

    def __ne__(self, rhs):
        r"""__ne__(SBBlock self, SBBlock rhs) -> bool"""
        return _lldb.SBBlock___ne__(self, rhs)
...
class SBCommandInterpreter(object):
    ...
    def InterruptCommand(self):
        ...
        :rtype: boolean
        :return: 
              **true** if there was a command in progress to receive the interrupt.
...
class SBExpressionOptions(object):
    ...
    def GetStopOnFork(self):
        r"""GetStopOnFork(SBExpressionOptions self) -> bool"""
        return _lldb.SBExpressionOptions_GetStopOnFork(self)

    def SetStopOnFork(self, stop_on_fork=False):
        r"""SetStopOnFork(SBExpressionOptions self, bool stop_on_fork=False)"""
        return _lldb.SBExpressionOptions_SetStopOnFork(self, stop_on_fork)
...
class SBFunction(object):
    ...
    def GetDeclaringType(self):
        r"""
        GetDeclaringType(SBFunction self) -> SBType
        ...
        """
        return _lldb.SBFunction_GetDeclaringType(self)
...
class SBHostOS(object):
    ...
    @staticmethod
    def GetScriptPath(language):
        r"""GetScriptPath(lldb::ScriptLanguage language) -> SBFileSpec"""
        return _lldb.SBHostOS_GetScriptPath(language)
...
class SBInstruction(object):
    ...
    def GetVariableAnnotations(self):
        r"""
        ...
        """
        return _lldb.SBInstruction_GetVariableAnnotations(self)
...
class SBProcessInfo(object):
    ...
    def GetNumArguments(self):
        r"""Returns the number of command line arguments for the described process."""
        return _lldb.SBProcessInfo_GetNumArguments(self)
    ...
    def GetArgumentAtIndex(self, idx):
        ...
        """
        return _lldb.SBProcessInfo_GetArgumentAtIndex(self, idx)
...
class SBTarget(object):
    ...
    def FindGlobalVariableByAddress(self, vm_addr):
        r"""
        FindGlobalVariableByAddress(SBTarget self, lldb::addr_t vm_addr) -> SBValue
            ...
            @return
                An SBValue that gets filled in with the found variable (if any).
        """
        return _lldb.SBTarget_FindGlobalVariableByAddress(self, vm_addr)
...
class SBThread(object):
    ...
    def GetThreadPointer(self):
        r"""
        GetThreadPointer(SBThread self) -> lldb::addr_t
        ...
        """
        return _lldb.SBThread_GetThreadPointer(self)
...
class SBTypeMemberFunction(object):
    ...
    def GetDeclaration(self):
        r"""
        GetDeclaration(SBTypeMemberFunction self) -> SBDeclaration
        ...
        """
        return _lldb.SBTypeMemberFunction_GetDeclaration(self)
...
class SBType(object):
    ...
    def GetDeclaration(self):
        r"""
        GetDeclaration(SBType self) -> SBDeclaration
        Returns the declaration location for this type, if debug info provides one.

            Returns an invalid `SBDeclaration` when this type is invalid or the
            declaration location is unavailable.

        """
        return _lldb.SBType_GetDeclaration(self)
    ...
    def GetContainingType(self):
        r"""GetContainingType(SBType self) -> SBType"""
        return _lldb.SBType_GetContainingType(self)
...
class SBValue(object):
    ...
    def GetParent(self):
        r"""GetParent(SBValue self) -> SBValue"""
        return _lldb.SBValue_GetParent(self)
    ...
    def GetDeclaringType(self):
        r"""
        GetDeclaringType(SBValue self) -> SBType
            ...
            is available.
        """
        return _lldb.SBValue_GetDeclaringType(self)
...
class SBVariablesOptions(object):
    ...
    def GetIncludeSynthetic(self):
        r"""GetIncludeSynthetic(SBVariablesOptions self) -> bool"""
        return _lldb.SBVariablesOptions_GetIncludeSynthetic(self)

    def SetIncludeSynthetic(self, arg2):
        r"""SetIncludeSynthetic(SBVariablesOptions self, bool arg2)"""
        return _lldb.SBVariablesOptions_SetIncludeSynthetic(self, arg2)
